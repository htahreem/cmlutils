...
class ApiV1Endpoints(Enum):
    ...
    API_KEY = "/api/v1/users/$owner/apikey"
    RUNTIMES = "/api/v1/runtimes"
    USER_INFO = "/api/v1/users/$owner"
    PROJECTS_SUMMARY = "/api/v1/users/$owner/projects-summary?all=true&scope=all&context=$username&sortColumn=updated_at&projectName=$projectName&limit=$limit&offset=$offset"
